...
import { deletePlant } from "@/lib/actions/plants";

export function DeletePlantButton({ plantId }: { plantId: number }) {
  ...
  return (
    <>
      ...
      <Sheet
        ...
        title="Pflanze wirklich entfernen"
      >
        <div className="flex flex-col gap-4">
          <p className="text-sm text-forest-muted">
            Die Pflanze inkl. aller Fotos, Notizen und Zonenzuordnungen wird
