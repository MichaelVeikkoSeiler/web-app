...
import { searchSpecies, correctPlantSpecies } from "@/lib/actions/plants";

export function SpeciesCorrection({ plantId }: { plantId: number }) {
  ...
  function handleSelect(scientificName: string) {
    ...
    startTransition(async () => {
      const result = await correctPlantSpecies(plantId, scientificName);
      if (result.ok) {
        close();
        router.refresh();
      } else {
