...
import { PlantMatch } from "@/components/spiele/plant-match";
import type { PlantCompareRow } from "@/lib/plant-compare";

export default async function PflanzenMatchPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <h1 className="font-display text-2xl text-forest">Pflanzen-Match</h1>
      <PlantMatch pool={pool} />
    </div>
  );
}
